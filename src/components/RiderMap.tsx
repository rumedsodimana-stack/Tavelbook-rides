  ...
  return L.divIcon({
    ...
    html: `
      <div class="relative flex items-center justify-center w-10 h-10">
        ...
        <div class="relative z-10 flex items-center justify-center w-8 h-8 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full shadow-lg border-2 border-white/20 backdrop-blur-md text-white">
...
const createLocationIcon = (isDestination: boolean = false) => {
  return L.divIcon({
    ...
    html: `
      <div class="relative flex items-center justify-center w-10 h-10">
        <div class="relative z-10 flex items-center justify-center w-8 h-8 ${isDestination ? 'bg-indigo-500' : 'bg-green-500'} rounded-full shadow-lg border-2 border-white/20 text-white">
